...
function IconHome({ active }) {
  const c = active ? '#7C6AF7' : '#2A4A7A';
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M3 9.5L10 3L17 9.5V17H13V13H7V17H3V9.5Z" stroke={c} strokeWidth="1.5" strokeLinejoin="round" fill={active ? '#7C6AF720' : 'none'} />
    </svg>
  );
}
...
function IconPlan({ active }) {
  ...
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <rect x="3" y="3" width="14" height="14" rx="3" stroke={c} strokeWidth="1.5" fill={active ? '#7C6AF720' : 'none'} />
...
function IconJournal({ active }) {
  ...
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <circle cx="10" cy="10" r="7" stroke={c} strokeWidth="1.5" fill={active ? '#7C6AF720' : 'none'} />
